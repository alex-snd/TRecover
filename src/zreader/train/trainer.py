...
from zreader.utils.model import save_params
from zreader.utils.train import ExperimentParams, optimizer_to_str, transfer
...
class LocalTrainer(object):
    ...
    def __exit__(self, exc_type: Union[None, Type[BaseException]],
        ...
        with tempfile.TemporaryDirectory() as dp:
            ...
            self.model.save(Path(dp, 'z_reader.pt'))
